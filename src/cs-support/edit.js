...
export default function Edit( { attributes, setAttributes } ) {
	...
	return (
		<div { ...blockProps }>
			<InspectorControls>
				<PanelBody
					title={ __( 'Form Content', 'clientsync-support' ) }
					initialOpen={ true }
				>
					<ToggleControl
				...
				<PanelBody
					title={ __( 'Behavior', 'clientsync-support' ) }
					initialOpen={ false }
				>
					<SelectControl
						label={ __(
						...
						onChange={ ( value ) =>
							setAttributes( { redirectPage: value } )
						}
						help={ __(
				...
				<PanelBody
					title={ __( 'Form Layout', 'clientsync-support' ) }
					initialOpen={ false }
				>
					<UnitControl
				...
				<PanelBody
					title={ __( 'Form Border', 'clientsync-support' ) }
					initialOpen={ false }
				>
					<UnitControl
				...
				<PanelBody
					title={ __( 'Input Fields', 'clientsync-support' ) }
					initialOpen={ false }
				>
					<UnitControl
						label={ __(
				...
				>
					<SelectControl
						...
						options={ [
							{
								label: __( 'Left', 'clientsync-support' ),
								value: 'left',
							},
							{
								label: __( 'Center', 'clientsync-support' ),
								value: 'center',
							},
							{
								label: __( 'Right', 'clientsync-support' ),
								value: 'right',
							},
						] }
						onChange={ ( value ) =>
					...
					<ToggleControl
						...
						onChange={ ( value ) =>
							setAttributes( { buttonFullWidth: value } )
						}
					/>
					<UnitControl
						label={ __(
			...
			<div className="cs-support-form-preview" style={ formStyle }>
				...
				<div className="cs-form-field">
					<label htmlFor="cs-category">
						{ __( 'Category', 'clientsync-support' ) }
					</label>
					<select id="cs-category" disabled style={ inputStyle }>
						<option>
							{ __( 'Select a category', 'clientsync-support' ) }
						</option>
						<option>
							{ __( 'Technical', 'clientsync-support' ) }
						</option>
						<option>
							{ __( 'Billing', 'clientsync-support' ) }
						</option>
						<option>
							{ __( 'General', 'clientsync-support' ) }
						</option>
					</select>
				</div>

				<div className="cs-form-field">
					<label htmlFor="cs-priority">
						{ __( 'Priority', 'clientsync-support' ) }
					</label>
					<select id="cs-priority" disabled style={ inputStyle }>
						<option>{ __( 'Low', 'clientsync-support' ) }</option>
						<option>
							{ __( 'Normal', 'clientsync-support' ) }
						</option>
						<option>{ __( 'High', 'clientsync-support' ) }</option>
						<option>
							{ __( 'Urgent', 'clientsync-support' ) }
						</option>
					</select>
				</div>
