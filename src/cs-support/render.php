...
if ($is_shortcode) {
	$wrapper_class = 'wp-block-clientsync-cs-support cs-support-shortcode';
} else {
...
<?php if ($is_shortcode): ?>
	...
	<?php else: ?>
		<div <?php
		// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- get_block_wrapper_attributes() output is safe
		...
		<?php else: ?>
			<div class="cs-support-ticket-form" style="<?php echo esc_attr($form_style); ?>">
				...
				<form id="cs-support-form" data-redirect-url="<?php echo esc_url($redirect_url); ?>">
					...
					<button type="submit" class="cs-form-submit" style="<?php echo esc_attr($button_style); ?>"
