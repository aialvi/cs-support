	...
	return (
		<div { ...blockProps }>
			<InspectorControls>
				{ /* Basic Settings */ }
				<PanelBody
					title={ __( 'Basic Settings', 'clientsync-support' ) }
					initialOpen={ true }
				>
					<RangeControl
						...
						onChange={ ( value ) =>
							setAttributes( { ticketsPerPage: value } )
						}
						min={ 1 }
						max={ 50 }
						help={ __(
					...
					<SelectControl
						...
						options={ [
							{
								label: __( 'Small', 'clientsync-support' ),
								value: 'small',
							},
							{
								label: __( 'Medium', 'clientsync-support' ),
								value: 'medium',
							},
							{
								label: __( 'Large', 'clientsync-support' ),
								value: 'large',
							},
							{
								label: __(
					...
					<SelectControl
						...
						options={ [
							{
								label: __( 'Tight', 'clientsync-support' ),
								value: 'tight',
							},
							{
								label: __( 'Normal', 'clientsync-support' ),
								value: 'normal',
							},
							{
								label: __( 'Loose', 'clientsync-support' ),
								value: 'loose',
							},
						] }
						onChange={ ( value ) =>
					...
					<SelectControl
						...
						options={ [
							{
								label: __( 'None', 'clientsync-support' ),
								value: 'none',
							},
							{
								label: __(
						...
						help={ __(
							'Maximum width of the support ticket container',
							'clientsync-support'
						) }
					/>
				</PanelBody>
				...
				{ /* Layout & Display */ }
				<PanelBody
					title={ __( 'Layout & Display', 'clientsync-support' ) }
					initialOpen={ false }
				>
					<SelectControl
						...
						options={ [
							{
								label: __( 'Default', 'clientsync-support' ),
								value: 'default',
							},
							{
								label: __( 'Modern', 'clientsync-support' ),
								value: 'modern',
							},
							{
								label: __( 'Minimal', 'clientsync-support' ),
								value: 'minimal',
							},
						] }
						onChange={ ( value ) =>
						...
						help={ __(
							'Overall visual style of the support interface',
							'clientsync-support'
						) }
					/>
					...
					<ToggleControl
						...
						help={ __(
							'Use tighter spacing for a more compact layout',
							'clientsync-support'
						) }
					/>
					...
					<ToggleControl
						...
						help={ __(
							'Allow users to search through their tickets',
							'clientsync-support'
						) }
					/>
					...
					<ToggleControl
						...
						help={ __(
							'Display filter buttons for ticket status',
							'clientsync-support'
						) }
					/>
					...
					<ToggleControl
						...
						help={ __(
							'Allow users to sort tickets by clicking column headers',
							'clientsync-support'
						) }
					/>
				</PanelBody>
				...
				{ /* Table Settings */ }
				<PanelBody
					title={ __( 'Table Settings', 'clientsync-support' ) }
					initialOpen={ false }
				>
					<ToggleControl
						...
						onChange={ ( value ) =>
							setAttributes( { tableStriped: value } )
						}
						help={ __(
					...
					<ToggleControl
						...
						onChange={ ( value ) =>
							setAttributes( { tableBordered: value } )
						}
						help={ __(
					...
					<ToggleControl
						...
						onChange={ ( value ) =>
							setAttributes( { rowHoverEffect: value } )
						}
						help={ __(
				...
				{ /* Visual Effects */ }
				<PanelBody
					title={ __( 'Visual Effects', 'clientsync-support' ) }
					initialOpen={ false }
				>
					<RangeControl
					...
					<SelectControl
						...
						options={ [
							{
								label: __( 'Rounded', 'clientsync-support' ),
								value: 'rounded',
							},
							{
								label: __( 'Square', 'clientsync-support' ),
								value: 'square',
							},
							{
								label: __( 'Pill', 'clientsync-support' ),
								value: 'pill',
							},
							{
								label: __( 'Outlined', 'clientsync-support' ),
								value: 'outlined',
							},
						] }
						onChange={ ( value ) =>
				...
				<PanelColorSettings
					...
					colorSettings={ [
						...
						},
						{
							value: warningColor,
							onChange: ( value ) =>
								setAttributes( { warningColor: value } ),
							label: __(
								'Warning Color (In Progress)',
								'clientsync-support'
							),
						},
						{
						...
						},
						{
							...
							onChange: ( value ) =>
								setAttributes( { secondaryColor: value } ),
							label: __(
								'Secondary Color',
								'clientsync-support'
							),
			...
			>
				...
				{ ( showSearch || showFilters ) && (
					<div
						className="cs-support-controls"
						style={ { marginBottom: getSpacingValue( spacing ) } }
					>
						{ showSearch && (
							<input
								type="search"
				...
				<div className="cs-support-frontend-content">
					<div className="cs-support-tickets-preview">
						<table
							className="cs-support-tickets-table"
							style={ tableStyle }
						>
							<thead>
						...
						<p
							className="cs-support-placeholder-text"
							style={ {
								textAlign: 'center',
						...
						>
							{ __(
								'✨ This is a preview. Actual tickets will appear here on the frontend.',
								'clientsync-support'
							) }
						</p>
					</div>
